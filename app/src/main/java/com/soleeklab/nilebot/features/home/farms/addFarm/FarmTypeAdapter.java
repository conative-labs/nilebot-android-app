...
public class FarmTypeAdapter extends ArrayAdapter<String> {
    ...
    public FarmTypeAdapter(Context context, int textViewResourceId, ArrayList<String> objects) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        String farmType = farmTypesArrayList.get(position);
