...
public class PondFilterTypeAdapter extends ArrayAdapter<String> {
    ...
    public PondFilterTypeAdapter(Context context, int textViewResourceId, ArrayList<String> objects) {
